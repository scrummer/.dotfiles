# Determine platform (Linux or Mac)
unameOut="$(uname -s)"
case "${unameOut}" in
    Linux*)     export OS_TYPE="LINUX";;
    Darwin*)    export OS_TYPE="MACOS";;
    *)          export OS_TYPE="UNKNOWN:${unameOut}"
esac
...
plugins=(git fzf zsh-fzf-history-search zsh-autosuggestions zsh-syntax-highlighting gpg-agent tmux thefuck poetry)
